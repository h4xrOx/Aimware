----This is a free lua for the forum. If you buy it, you will be circled.
----72878713023 Repair and change
----Original address https://aimware.net/forum/thread/143817
local widget = {
...
qiskaiindicatorWindow = gui.Window("qiskaiindicator", "aimware indicator", 100, 300, 300, 200);
...
local function drawspectators(spectators)
    ...
    for index, players in pairs(spectators) do
        ...
        temp=true;
        draw.SetFont(font);
        draw.Color(gui.GetValue("qiskaiindicator.speclist.stextCol"));--audience name color
...
local function drawRectFillcol(r, g, b, a, x, y, w, h, texture)
    ...
    draw.Color(gui.GetValue("qiskaiindicator.speclist.smainCol"));--background color
    draw.FilledRect(x, y, x + w, y + h);
end
